...
export const MessagingPlatformField: React.FC<MessagingPlatformFieldProps> = ({
  value = { is_imessage_persona: false, is_telegram_persona: false },
  onChange,
}) => {
  return (
    <div className="flex items-center justify-between gap-4">
      ...
      <Tooltip>
        ...
        <TooltipContent>
          <p>
            Each messaging platform can have only one active persona but any <br></br> given persona
            can be enabled for multiple platforms simultaneously. <br></br> Further, all personas
            will remain accessible through the web interface.
          </p>
        </TooltipContent>
      </Tooltip>
    </div>
